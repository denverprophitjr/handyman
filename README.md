...
**HandyMan is a starting point for [Jekyll](https://jekyllrb.com/) projects. Rather than starting from scratch, this boilerplate theme is designed to get rolling immediately. Install it, configure it, tweak it, push it.**

## Features

- Available as a **theme gem** and **GitHub Pages** theme **TODO**
...
Here are a few examples of HandyMan out in the wild being used in a variety of ways:

- [HandyMan Website Template](https://handyman2.denverprophit.us/)
...
- Thanks to [HTML5UP](https://html5up.net/) for providing the foundation of this theme in static website format.
